export const GAME_PRELOAD     = 'game.preload';
...
export const PERFORMED_ACTION_TRADE   = 'performed.action.trade';
export const PERFORMED_ACTION_BOLSTER = 'performed.action.bolster';
export const PERFORMED_ACTION_UPGRADE = 'performed.action.ugrade';
export const PERFORMED_ACTION_DEPLOY  = 'performed.action.deploy';
