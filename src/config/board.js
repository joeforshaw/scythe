...
export default {
  ...
  data: [
    ...
    [
      ...
      { x: 4, y: 1, type: Territories.FOREST, rivers: [TerritorySides.LEFT, TerritorySides.BOTTOM_LEFT] },
    ...
    [
      ...
      { x: 1, y: 2, type: Territories.TUNDRA, encounter: true, rivers: [TerritorySides.BOTTOM_LEFT] },
      ...
      { x: 6, y: 2, type: Territories.FARM, encounter: true, rivers: [TerritorySides.BOTTOM_RIGHT, TerritorySides.BOTTOM_LEFT] }
    ],
    // Row 4
    [
      ...
      { x: 2, y: 3, type: Territories.MOUNTAIN, tunnel: true, rivers: [TerritorySides.BOTTOM_LEFT, TerritorySides.LEFT] },
    ...
    // Row 5
    [
      { x: 0, y: 4, type: Territories.FARM, rivers: [TerritorySides.BOTTOM_RIGHT, TerritorySides.BOTTOM_LEFT] },
      { x: 1, y: 4, type: Territories.VILLAGE, encounter: true, rivers: [TerritorySides.TOP_RIGHT, TerritorySides.BOTTOM_RIGHT, TerritorySides.BOTTOM_LEFT] },
      ...
      { x: 5, y: 4, type: Territories.TUNDRA, encounter: true, rivers: [TerritorySides.BOTTOM_LEFT, TerritorySides.LEFT, TerritorySides.TOP_LEFT] },
    ...
    [
      ...
      { x: 1, y: 5, type: Territories.FOREST, rivers: [TerritorySides.TOP_RIGHT, TerritorySides.BOTTOM_RIGHT, TerritorySides.BOTTOM_LEFT, TerritorySides.TOP_LEFT] },
      { x: 2, y: 5, type: Territories.FARM, tunnel: true, rivers: [TerritorySides.BOTTOM_LEFT, TerritorySides.TOP_LEFT] },
    ...
    [
      ...
      { x: 3, y: 6, type: Territories.TUNDRA, tunnel: true, rivers: [TerritorySides.BOTTOM_RIGHT, TerritorySides.BOTTOM_LEFT] },
      { x: 4, y: 6, type: Territories.FOREST, rivers: [TerritorySides.BOTTOM_LEFT] },
